# voice.md — Dexon Padel (Instagram)

> Nota de instalación: el pack `instagram-agent-skill` espera este archivo en
> `~/.claude/instagram/voice.md` (nivel usuario). En este entorno esa carpeta
> no persiste entre sesiones, así que lo guardamos acá, versionado con el
> repo. Cuando uses cualquier skill `ig-*`, este es el archivo de voz a leer.
> Ya está prellenado con lo que salió de la conversación con
> `social-media-context-sms` — completá lo que falta.
...
> Tono ya definido en `.agents/social-media-context-sms.md`: confiable/informativo,
> entusiasta pero sobrio, semi-formal (no muy casual), humor sutil y ocasional.
...
- **My keyword CTA, if I use one:** [PENDIENTE — ej: "Comentá CANCHA" para que te escriban por turnos]
- **What the keyword sends them:** [PENDIENTE]
- **Where my link goes:** [PENDIENTE — link en bio a la reserva]

---

## Content pillars (de social-media-context-sms.md)

1. Turnos y disponibilidad
2. Programa de referidos
3. El boom del pádel en la región

## Platforms

- Instagram (principal) — promoción eventual vía Meta Business Manager / cuenta directa
- Grupo de WhatsApp — sin skill dedicada; usar el mismo tono, redactar para copiar y pegar
