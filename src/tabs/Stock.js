  ...
  return <div>
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isMobile ? 12 : 16, gap: 8, flexWrap: "wrap" }}>
      ...
      <div style={{ display: "flex", gap: 6 }}>
        <Btn v="ghost" sm={isMobile} onClick={() => openM("verQR", { path: "/precios", tituloQR: "Lista de precios pública", descripcionQR: "Apunta a la lista de precios pública, conectada con el stock activo. Imprimí este QR para las mesas o la recepción.", filenameQR: "lista-precios-qr.svg" })}>QR / Lista pública</Btn>
